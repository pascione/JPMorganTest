...
public class TestMessage1 {
	...
	private static final String insertedAdjustmentMessage = "Message Received\r\n"+
			"10 message received: Detailed Report\r\n"+
			"Product: apple Total Sales:10 Total Value:120\r\n";
	private static final String inserted50Message = 
	"Message Received\r\n" +
	"10 message received: Detailed Report\r\n"+
	"Product: apple Total Sales:50 Total Value:600\r\n"+
	"\r\n" + 	
	"50 message received: Application is in pause\r\n"+
	"Report of adjustments messages received\r\n"+
	"Adjustment Operation: ADD 2p to apple\r\n";
	...
	public void setUp() throws Exception {
		...
		opMessage.setAdjPrice(new BigDecimal(2));
		messageAdjustment.setOperation(opMessage);
	}
	...
	public void testAdjustmentMessageReceived() {
		...
		logMessage = queue.queueMessage(messageAdjustment);
		
		Assert.assertEquals(insertedAdjustmentMessage, logMessage);
	}
	@Test
	public void test50MessageReceived() {
		...
		Assert.assertEquals(inserted50Message, logMessage);
	}
}
